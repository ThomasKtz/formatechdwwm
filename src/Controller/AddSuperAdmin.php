   ...
   public function manage()
   {
      ...
      if (isset($_POST["firstname"])) {
         ...
         if ($checkExistingCity) {
            ...
            $this->modelSuperAdmin->addOneSuperAdmin($_POST['civility'], $_POST["firstname"], $_POST["lastname"], $_POST["phone"], $_POST["email"], $passwordhash, $_POST["street"], $city["city_id"]);
         } else {
      ...
      include (__DIR__ . '/../View/AddSuperAdmin.php');
